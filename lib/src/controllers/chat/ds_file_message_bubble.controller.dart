...
class DSFileMessageBubbleController extends GetxController {
  ...
  String getAsset(final String filename) {
    ...
    final String extension =
        path_utils.extension(filename).isNotEmpty ? path_utils.extension(filename).substring(1) : '';

    return path_utils.join(path, 'file-${extension.length > 3 ? extension.substring(0, 3) : extension}.png');
  }
